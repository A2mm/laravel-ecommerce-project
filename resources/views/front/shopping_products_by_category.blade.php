...
@endif
        ...
        <h4 class="text-center shop-page-heading">Now, Shop ( <span class="category-count"> {{ $products->total() }} ) </span> Products in 
            category ( <span class="category-name">{{ $category->name }}</span> ) 
        </h4>
</div>
</div>
