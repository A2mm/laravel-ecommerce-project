...
<div class="panel panel-default category-panel">
	<div class="panel-heading">
		<h1 class="text-center"> <u>Update Category {{$category->name}}</u> </h1>
	</div>
	...
	<form class="form-horizontal" method="post" action="/update/category">
		...
		<div class="form-group">
			<label class="col-md-4 control-label checkbox-inline"><b>Category Status</b></label>
			<div class="col-md-6">
				<input type="checkbox" name="status" class="checkbox" {{$category->status == 1 ? 'checked' : ''}}>
			</div>
		</div>
